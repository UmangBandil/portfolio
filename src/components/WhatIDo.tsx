...
const WhatIDo = () => {
  ...
  useEffect(() => {
    const currentRefs = containerRef.current;
        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Creating robust and scalable APIs and microservices. Deploying and maintaining CI/CD pipelines and infrastructure.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
